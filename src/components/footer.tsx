...
type FooterProps = Pick<PageProps, 'translations'>

const Footer: FunctionalComponent<FooterProps> = ({ translations }) => {
      ...
      <div class={styles.footerContent}>
        <div class={styles.grid}>
          <div class={styles.about}>
            ...
            <p>{useTranslation('footer-about')}</p>
          ...
          {translations.length > 0 && (
            <div class={styles.translations}>
              <div class={styles.translationsHeader}>
                {useTranslation('language-select')}
              </div>
              <ul>
                {translations.map((t) => {
                  return (
                    <li>
                      <a href={t.url}>
                        {
                          allLanguages.find((l) => l.code === t.languageCode)!
                            .name
                        }
                      </a>
                      &nbsp;&nbsp;
          ...
          <div class={styles.copyright}>
            {useTranslation('footer-copyright')} © Christoph Werner 2022
          </div>
        </div>
      </div>
    </footer>
