...
const useDeviceOrientation = ({ decimals = 2, throttle = 100 } = {}) => {
  type AlphaBetaGamma = { alpha: any; beta: any; gamma: any }
  type State = {
    initial: AlphaBetaGamma | null
    orientation: any | null
    inferred: AlphaBetaGamma
  }
  type Action = { type: 'DEVICE_ORIENTATION'; payload: AlphaBetaGamma }
  ...
  let currentRotMat = useRef<mat3>(),
    previousRotMat = useRef<mat3>(),
    inverseMat = useRef<mat3>(),
    relativeRotationDelta = useRef<mat3>(),
